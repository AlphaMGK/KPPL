...
<html>
<head>
<title>Panah Cakrawala || Register</title>
<!-- for-mobile-apps -->
...
<!-- register -->
	...
	<div class="register">
		<div class="container">
			<h3 class="animated wow zoomIn" data-wow-delay=".5s">Daftar</h3>
			<!--<p class="est animated wow zoomIn" data-wow-delay=".5s">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia
				deserunt mollit anim id est laborum.</p>-->
			<div class="login-form-grids">
				<center>
				<h5 class="animated wow slideInUp" data-wow-delay=".5s">Profil Anda</h5>
				</center>
				<p>
				<?php
					echo validation_errors();
				?></p>
				<form class="animated wow slideInUp" data-wow-delay=".5s" action="<?php echo base_url().'index.php/custManager/registrasi'; ?>" method="post">
					<input type="text" placeholder="Nama Depan..." required=" " name="firstName" >
					<input type="text" placeholder="Nama Belakang..." required=" " name="lastName" >
					...
					<input type="email" placeholder="Email Address" required=" " name="email" > <?php echo form_error('email');?>
					<input type="password" placeholder="Password" required=" " name="password" > <?php echo form_error('password');?>
					<input type="password" placeholder="Konfirmasi Password" required=" " name="passwordcon" ><br> <?php echo form_error('passwordcon');?>
