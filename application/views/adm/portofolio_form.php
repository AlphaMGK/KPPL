            ...
            <div class="row-fluid">
                <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        ...
                        <li>
                            <a href="list_order.html"><span class="badge badge-success pull-right">731</span> Orders</a>
                        </li>
                        <li>
                            <a href="list_users.html"><span class="badge badge-info pull-right">1,234</span> Users</a>
                        </li>
                    </ul>
                </div>
                <!--/span-->
