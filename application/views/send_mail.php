...
<html>
<head>
<title>Panah Cakrawala || Resett Password</title>
<!-- for-mobile-apps -->
...
<!-- login -->
	<div class="login">
		<div class="container">
			...
			<p class="est animated wow zoomIn" data-wow-delay=".5s" style="color: #d8703f"> Reset password menggunakan alamat e-mail.</p>
			<div class="login-form-grids animated wow slideInUp" data-wow-delay=".5s">
				<form method="post" action="<?php echo base_url().'index.php/custManager/forget_password'?>">
