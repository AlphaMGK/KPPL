...
<html>
<head>
<title>Panah Cakrawala || Login</title>
<!-- for-mobile-apps -->
		...
		<div class="container">
			...
			<div class="login-form-grids animated wow slideInUp" data-wow-delay=".5s">
				<form method="post" action="<?php echo base_url().'index.php/custManager/do_login'?>">
					...
					<br>
					<p class="animated wow slideInUp" data-wow-delay=".5s"><a href="<?php echo base_url().'index.php/custManager/input_email'?>">Lupa Password</a> 
				</form>
			</div>
